...
| `TASKS.md` | สถานะงานทั้งระบบ: อะไรเสร็จ/ค้าง รายโดเมน-รายหน้า — **อัปเดตด้วยมือ** |
| `BACKEND.md` | โครงสร้างเชิงลึก backend: ตาราง DB ทั้งหมด, request flow, migration timeline — **อัปเดตด้วยมือ** |
| `FRONTEND.md` | โครงสร้างเชิงลึก frontend: 5 ชั้น, 16 features, กฎ linter, flow เปิดหน้า — **อัปเดตด้วยมือ** |
